  ...
  return (
    <div className=" hidden md:block h-screen overflow-y-clip p-5 shadow-lg   min-h-screen overflow-hidden w-[240px]">
      <ul className="text-sm">
        ...
        <li className="flex items-center py-2 cursor-pointer">
          <img className="pr-4" src="./Subscriptions.svg" alt="home" />{' '}
          Subscriptions
        </li>
      </ul>
      ...
      <ul className="text-sm">
        <li className="py-2 cursor-pointer">
          <Link className="flex items-center " to="/">
            <img className="pr-4" src="./trending.svg" alt="trending" />{' '}
            Trending
          </Link>
        </li>
        <li className="py-2 cursor-pointer">
          <Link className="flex items-center " to="/">
            <img className="pr-4" src="./shopping.svg" alt="shopping" />{' '}
            Shopping
          </Link>
        </li>
        <li className="py-2 cursor-pointer">
        ...
        <li className="py-2 cursor-pointer">
          <Link className="flex items-center " to="/">
            <img className="pr-4" src="./f&b.svg" alt="gaming" /> Fashion &
            Beauty
          </Link>
        </li>
        <li className="py-2 cursor-pointer">
          <Link className="flex items-center " to="/">
            <img className="pr-4" src="./podcast.svg" alt="gaming" /> Podcasts
          </Link>
        </li>
      </ul>

      <h1 className="font-bold pt-5 pb-2 border-t border-gray-300">
        More from YouTube
      </h1>
      <ul className="text-sm">
        <li className="py-2 cursor-pointer">
          <Link className="flex items-center " to="/">
            <img className="pr-4 w-10" src="./premium.svg" alt="gaming" />{' '}
            YouTube Premium
          </Link>
        </li>
        <li className="py-2 cursor-pointer">
          <Link className="flex items-center " to="/">
            <img className="pr-4 w-10" src="./ymusic.svg" alt="gaming" />{' '}
            YouTube Music
          </Link>
        </li>
        <li className="py-2 cursor-pointer">
          <Link className="flex items-center " to="/">
            <img className="pr-4 w-10" src="./ykids.svg" alt="gaming" /> YouTube
            Kids
          </Link>
        </li>
      </ul>
        ...
        <div className="w-4/6 h-screen bg-white py-4">
          ...
          <ul className="text-md pt-8">
            <li className="py-3 cursor-pointer">
              <Link className="flex items-center " to="/">
                <img className="pr-6" src="./trending.svg" alt="trending" />{' '}
                Trending
              </Link>
            </li>
            <li className="py-3 cursor-pointer">
              <Link className="flex items-center " to="/">
                <img className="pr-6" src="./shopping.svg" alt="shopping" />{' '}
                Shopping
              </Link>
            </li>
            <li className="py-3 cursor-pointer">
